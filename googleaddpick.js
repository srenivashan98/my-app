...
Geocode.setApiKey("AIzaSyDVqIIRBN7Pyz_uuF6UxKDjKamEFmkcsa4");
Geocode.enableDebug();
...
class LocationSearchModal extends React.Component {
    ...
    //         this.state.address !== nextState.address ||cons
    ...
    render() {
        ...
        return (
            <div style={{ padding: '1rem', margin: '0 auto', maxWidth: 500 }}>
                <AsyncMap
                    googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyDVqIIRBN7Pyz_uuF6UxKDjKamEFmkcsa4&libraries=places"
                    loadingElement={
                        <div style={{ height: `50%` }} />
                    }
                    containerElement={
